---
layout: series-post
title: "Part 0: Why I Built Wireless Bicycle Turn Signals"
date: 2026-08-16 12:00:00 -0600
series: turn-signal
part: 0
covers: "Mid August 2026"
excerpt: "An injured wrist, dark streets and a bursary: why this project exists, what I bought to build it, and why it stopped being a jacket."
...
*A 480-piece, 24-value ceramic assortment, 10 pF to 10 µF, 50 V. The 100 nF row is the one this project actually needed, for decoupling right at the microcontroller.*
{: .caption}

![Through-hole resistor kit with the colour code chart on the lid](/images/resistor_kit.jpg)

*The resistor kit. The band-code chart lives on the lid, which is exactly where a beginner needs it. The 33 Ω bag in here is what every one of the 16 LED strings uses.*
{: .caption}

![Electrolytic capacitor assortment in a 24-compartment tray](/images/electrolytic_kit.jpg)

*Electrolytics, sorted by value. The 470 µF that sits across the supply rail on the panel came out of this tray.*
{: .caption}

---

## Why turn signals specifically
